...
description: A closer look at android intents.
date: 2017-10-06
categories: android
...
The tradespeople will have, at some stage, told Android what they can do. However, they do not tell Android what they cannot do. Android will assume if they have not said they can do it, they simply can't do it. Android will evaluate the job to be done, and select one or more tradespeople who can build a timber frame, lay insulation and lay the roof tiles. If any tradespeople can do only one or two of those tasks, they are not considered. If one tradesperson can do all three, but has only told Android they can build a timber frame and lay the roof tiles, they are not considered. Intent filters need to match the entire list of categories in order to be considered.
